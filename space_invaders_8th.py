...
def you_won_text():
    while True:
        ...
        level+=1
        print("why wont you sleep!!")
        print("why you no wait 10 secs")
        remove_text_you_won.start()
        print("wuuuuuuuut")
        return level
...
def get_rid():
    ...
    print("get rid")
    time.sleep(10)
    print("time over ur dead")
    won_text = won_font.render("hey hey",True, (255,255,255))
...
remove_text_you_won = threading.Thread(target=get_rid)
